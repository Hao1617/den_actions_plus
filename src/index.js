...
const { COOKIE, TOKEN } = require("./utils/config.js"); // 获取配置文件
const message = require("./utils/message"); // 消息通知
const jueJinApi = require("./api/juejin")(); // 掘金api
const miningApi = require("./api/mining")(); // 挖矿api
const jwt = require("jsonwebtoken");
const firstData = require("./utils/first"); // 第一次请求数据
...
if (!(COOKIE && TOKEN)) {
	...
	let deep = 0; // 深度
	let todayDiamond = 0; // 今日钻石
	let todayLimitDiamond = 0; // 今日限制钻石
